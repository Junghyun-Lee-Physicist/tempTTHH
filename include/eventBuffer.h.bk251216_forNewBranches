...
struct eventBuffer
{
 ...
 void close()
 {
   std::cout<<"debug : Before [ if( input ) input->close(); ] in close() function in eventBuffer"<<std::endl;
////   if( input )  input->close();
   ...
   std::cout<<"debug : Before [ if( output ) output->close(); ] in close() function in eventBuffer"<<std::endl;
   if( output ) output->close();
   std::cout<<"debug : End of close() function in eventBuffer"<<std::endl;
 }
