...
////////////////////////////////////////////////////////////////////////////
    ...
    if( isData ){
        if (underscorePos != kNPOS) {  // kNPOS는 찾지 못했을 때의 값
            ...
            std::cout<< "  [ makeBTagWeight_Final::Loop() ] : Current Sample --> Data "<< dataSet << ", Era : " << era << std::endl;
        } else {
            std::cout << "  [ makeBTagWeight_Final::Loop() ] : No underscore found in the string!" << std::endl;
            return;
        }
    }
