...
// Stack plot 생성 함수
void makeStackPlot(TString varName, TString histNameBase, TString xTitle, 
...
void makeBTagStackPlot()
{
    ...
    // nJets
    makeStackPlot("nJets", "h_nJets", "Number of Jets", 6, 15, outDir);
    
    // HT
    makeStackPlot("HT", "h_HT", "H_{T} [GeV]", 500, 2000, outDir);
    
    // jet0 pT
    makeStackPlot("jet0_pT", "h_jetPt", "Leading Jet p_{T} [GeV]", 50, 400, outDir, "jet0");
    
    // jet0 bTag
    makeStackPlot("jet0_bTag", "h_bTag", "Leading Jet b-tag Discriminant", 0.0, 1.0, outDir, "jet0");
 
    // jet0 eta
    makeStackPlot("jet0_eta", "h_jetEta", "Leading Jet #eta", -2.5, 2.5, outDir, "jet0");

    // jet1 pT
    makeStackPlot("jet1_pT", "h_jetPt", "Subleading Jet p_{T} [GeV]", 50, 400, outDir, "jet1");
    
    // jet1 bTag
    makeStackPlot("jet1_bTag", "h_bTag", "Subleading Jet b-tag Discriminant", 0.0, 1.0, outDir, "jet1");
    
    // jet1 eta
    makeStackPlot("jet1_eta", "h_jetEta", "Subleading Jet #eta", -2.5, 2.5, outDir, "jet1");
