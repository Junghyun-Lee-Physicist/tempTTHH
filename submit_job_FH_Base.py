...
class CondorJobManager:
    ...
    def __init__(self):
        ...
        self.nameofExe = "ttHHanalyzer_base" # Name of compiled execution file to run analyzer
        ##self.path_output_base = "/eos/user/t/tom/<eos-storage or anywhere you want to store the outputs>"
        self.path_output_base = "/eos/user/j/junghyun/ttHH/Btag_el9"
        self.os_version = "el9"
        self.memorySize = "10 GB"
        self.jobFlavour = "tomorrow"

        self.config_file_path = os.path.join(self.analyzer_path, "AnalyzerConfig/Base_2017_FH.yml")
        self.proxy_path = os.path.join(self.analyzer_path, "proxy.cert")
        self.condor_files_path = os.path.join(self.analyzer_path, "condor/filePath_Base")
